...
Currently, prototyping and under construction.
...
def arg_parser():
    ...
    parser.add_argument("account_number", type=str, help="The desired account identifier number")
    ...
    # NOTE, may wany this argument optional and if not produced,then goto default location
...
def main(args):
    ...
    # If the account doesnt exist, perform first time setup, depotist STARTING_AMOUNT_DOLLARS, and save
